...
public class VWTagHelpers {
    public static TagEntry block(Block block) {
        return TagEntry.element(BuiltInRegistries.BLOCK.getKey(block));
    }
    public static TagEntry entity(EntityType<?> types) {
        return TagEntry.element(BuiltInRegistries.ENTITY_TYPE.getKey(types));
    }
    public static TagEntry item(Item item) {
