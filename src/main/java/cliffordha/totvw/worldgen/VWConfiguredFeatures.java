...
public class VWConfiguredFeatures {
    ...
    public static void configure(BootstrapContext<ConfiguredFeature<?, ?>> context) {
        ...
        register(context, VERDANT_MOSS_VEGETATION_CONFIGURED_KEY, Feature.SIMPLE_BLOCK,
        ...
        register(context, VERIXIUM_FLUID_POND_CONFIGURED_KEY, Feature.LAKE,
                new LakeFeature.Configuration(
                        BlockStateProvider.simple(VWBlocks.VERIXIUM_FLUID),
                        BlockStateProvider.simple(Blocks.DEEPSLATE)

        ));
        register(context, VERDANT_SPRUCE_BUSH_TREE_CONFIGURED_KEY, Feature.TREE,
        ...
        register(context, VERDANT_SPRUCE_TREE_CONFIGURED_KEY, Feature.TREE,
                new TreeConfiguration.TreeConfigurationBuilder(
                        BlockStateProvider.simple(VWBlocks.VERDANT_SPRUCE_LOG),
        ...
        register(context, ANCIENT_VERDANT_SPRUCE_TREE_CONFIGURED_KEY, Feature.TREE,
                new TreeConfiguration.TreeConfigurationBuilder(
                        BlockStateProvider.simple(VWBlocks.VERDANT_SPRUCE_LOG),
