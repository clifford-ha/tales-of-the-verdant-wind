...
public class VWArmorMaterials {
    ...
    private static final ResourceKey<EquipmentAsset> VERIXIUM_ENTITY_ARMOR_MATERIAL_KEY = ResourceKey.create(EquipmentAssets.ROOT_ID,
            Identifier.fromNamespaceAndPath(TOTVW.MOD_ID, "verixium"));
    ...
    public static final ArmorMaterial VERIXIUM_ENTITY_ARMOR = new ArmorMaterial(
            ...
            0.0F,
            VWItemTags.REPAIRS_VERIXIUM,
            VERIXIUM_ENTITY_ARMOR_MATERIAL_KEY
    );
